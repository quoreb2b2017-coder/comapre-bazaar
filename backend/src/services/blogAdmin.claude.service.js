...
2) After the hero: intro, multiple **real** <h2> sections with <h3> where useful, <ul>/<li> or <ol>/<li> lists, then a short conclusion. Do not add a final CTA box, "Next step" banner, or quote buttons — the CMS appends one vertical CTA automatically.
