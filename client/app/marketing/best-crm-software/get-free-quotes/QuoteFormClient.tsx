...
export default function CRMQuotePage({ heading }: QuoteFormClientProps) {
  return (
    <QuoteLandingPageShell>
      ...
      <QuoteLandingHero
        ...
        heading={heading}
        description="Describe your requirements once. Within 24 hours, we'll match you with 3–5 CRM vendors whose features, pricing, and industry experience genuinely suit your team, completely free, no obligation."
        trustItems={[
