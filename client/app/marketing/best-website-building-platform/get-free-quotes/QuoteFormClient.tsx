...
const PAGE_DEFAULTS: QuoteLandingContent = {
  ...
  hero: {
    ...
    description:
      "Outline site type, page scope, and e‑commerce needs once. Within 24 hours we match you with platforms that fit templates, SEO, and budget, free and no obligation.",
    trustItems: [
...
export default function WebsiteBuildingQuotePage({ heading, landingContent }: QuoteFormClientProps) {
