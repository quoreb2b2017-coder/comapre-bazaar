                  ...
                  <div className="group">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {importantFeatures.map((feature) => (
                        <label
                          key={feature.id}
                          className={`relative flex items-start p-3 rounded-xl border-2 cursor-pointer transition-all duration-300 ${
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className={`inline-flex p-1.5 rounded-lg mb-1.5 ${
                              formData.importantFeatures.includes(feature.id)
