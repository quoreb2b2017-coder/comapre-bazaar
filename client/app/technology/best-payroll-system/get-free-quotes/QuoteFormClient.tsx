  ...
  return (
    <QuoteLandingPageShell>
      ...
      <QuoteLandingHero
        ...
        heading={heading}
        description="Share headcount, pay frequency, and preferred platforms once. Get aligned quotes from providers like ADP, OnPay, QuickBooks Payroll, and Gusto, free and no obligation."
        trustItems={[
