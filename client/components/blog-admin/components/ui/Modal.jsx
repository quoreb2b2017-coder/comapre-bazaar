...
/** Blog admin modals lock body scroll — reset if a modal closes mid-action. */
...
export const Modal = ({ isOpen, onClose, title, children, size = 'md' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" onClick={onClose ? onClose : undefined} />
          ...
          {title && (
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-800">
              ...
              <button
                ...
                onClick={onClose}
                disabled={!onClose}
                className="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all disabled:opacity-40"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
