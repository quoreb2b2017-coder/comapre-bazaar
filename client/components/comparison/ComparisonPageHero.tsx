  ...
  return (
    <header className="relative border-b border-gray-200 bg-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        ...
        <h1 className="mt-3 max-w-4xl font-serif text-[1.65rem] font-normal leading-[1.2] tracking-tight text-navy sm:text-[2rem] lg:text-[2.125rem]">
          {data.h1}
        </h1>

        <p className="mt-3 max-w-3xl text-[15px] leading-[1.7] text-gray-600">{data.intro}</p>

        <dl className="mt-5 flex flex-wrap gap-x-6 gap-y-2 border-t border-gray-100 pt-4 text-[13px]">
          <div>
