...
export function ComparisonSidebar({
  ...
  return (
    <aside className="w-full space-y-5" aria-label="Page navigation">
      ...
      <div id="get_free_quotes" className="scroll-mt-24">
        ...
        <Link
          href={ctaSlug}
          className="mt-3 flex w-full items-center justify-center rounded-xl bg-cb-orange px-4 py-2.5 text-[13px] font-semibold text-white shadow-md shadow-cb-orange/25 transition-all hover:bg-cb-orange-hover hover:shadow-lg"
        >
          Get free quotes →
        </Link>
      </div>
